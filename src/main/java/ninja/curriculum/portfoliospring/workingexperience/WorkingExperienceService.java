...
public class WorkingExperienceService {
	...
	public void updateWorkingExperience(Long workingExperienceId, LocalDate startedWork, LocalDate finishedWork,
			String jobDescription, String jobDescriptionIt, Long positionAtWorkId) {
		Optional<WorkingExperience> workingExperienceOptional = this.workingExperienceRepository
				.findById(workingExperienceId);
			...
			if (positionAtWorkId != null) {
				PositionAtWork positionAtWork = positionAtWorkRepository.findById(positionAtWorkId)
						.orElseThrow(() -> new IllegalStateException(
								"PositionAtWork with id " + positionAtWorkId + " does not exist"));
	...
	@Transactional
	public void deleteWorkingExperience(Long workingExperienceId) {
		this.workingExperienceRepository.deleteById(workingExperienceId);
	}
}